...
for (iter in 1:maxiter)
{
  ...
  bb=runif(lbnumber2,-1,1)*append(rep(1,Non_dimX+sparsecut2),c(decfac2^(0:(lbnumber2-sparsecut2-Non_dimX-1))))
  LBFX=LBF; LBFY=LBF
...
for (bd_val in bdw_list) {
  ...
  save_filename <- paste0("results/FRNENEWBLOCKSMALLKAPP_esignal", esignal, "_rho", rho, "_dn", Non_dimX, "_HS_bdw", bd_val, "_cuteigen", cuteigen, "_defac1", decfac1, ".RData")
