    ...
    { 
     ...
     # =======================================================================
      ...
      for (bd_val in bdw_list) {
        ...
        # 사용자님의 cuteigen 기반 수식 + Non_dimX+2 방어 로직 완벽 적용
        if (Kscheme==1){
...
for (bd_val in bdw_list) {
  ...
  save_filename <- paste0("results/FRNENEWBLOCKKAPP_esignal", esignal, "_rho", rho, "_dn", Non_dimX, "_HS_bdw", bd_val, "_cuteigen", cuteigen, "_defac1", decfac1, ".RData")
